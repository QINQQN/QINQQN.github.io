...
### 直接上代码 wxml
<viewclass="box"bindtouchstart="touchstart"bindtouchmove="touchmove"bindtouchend="touchend">

<viewanimation="{{animation1}}"bindtap="scrollLeft">

<imagesrc="{{clubs[0]}}"class="img"style="width:{{img_width_one}}rpx"mode='aspectFill'/>

</view>

<viewanimation="{{animation2}}"bindtap="scrollLeft">

<imagesrc="{{clubs[1]}}"class="img2"/>

</view>

<viewanimation="{{animation3}}">

<imagesrc="{{clubs[2]}}"class="img3"style="width:{{img_width_three}}rpx"mode='aspectFill'/>
...
console.log("touchMove: " + touchMove +", touchDot: " + touchDot +",
...
that.animation1.translateX(0).opacity(0.5).step({ duration:0,
 timingFunction:'linear' });
...
that.animation3.translateX(0).opacity(0.5).step({ duration:0,
 timingFunction:'linear' });
